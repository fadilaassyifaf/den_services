        ...
        <div className="flex-1 overflow-y-auto px-6 py-5 space-y-5">
          ...
          <div>
            ...
            <div className="flex flex-col gap-2">
              <button
                type="button"
                onClick={() => window.open('http://10.89.12.54:8000/template/intersite/Template_Topology_Based.xlsx', '_blank')}
              ...
              <button
                type="button"
                onClick={() => window.open('http://10.89.12.54:8000/template/intersite/Topology_Sample.kmz', '_blank')}
                className="w-full px-4 py-2.5 bg-[#1E99D5] text-white text-sm rounded-xl hover:bg-[#1a88bd] transition font-semibold flex items-center justify-center gap-2"
              >
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" />
                  ...
                  >
                    ...
                    {excelFile ? (
                      ...
                      <>
                        ...
                        <p className="text-xs font-medium text-gray-600">(Excel file with site coordinates)</p>
