...
import { BoqMmpTask } from '@features/iris/sub-features/report/utils/boq-mmp-task-manager';
...
export default function Page() {
  ...
  const taskManagerRef = useRef<BoqMmpTask | null>(null);

  useEffect(() => {
    taskManagerRef.current = new BoqMmpTask();
      ...
      <div className="flex flex-1 overflow-hidden gap-3 p-3">
        ...
        <div className="flex-1 overflow-y-auto border border-gray-200 bg-white relative" style={{ borderRadius: '14px' }}>
          ...
          <div className="sticky top-0 z-10 bg-white px-5 pt-5 pb-4 border-b border-gray-100">
            ...
            <p className="text-[#1E99D5] text-xs m-0">Create MMP BOQ Report based on Implementation KMZ</p>
          </div>
              ...
              <div className="grid grid-cols-2 gap-3 mb-5">
                ...
                <div>
                  ...
                  <ul className="text-[10px] text-[#11499E] space-y-0.5 list-disc list-inside mb-3">
                    ...
                    <li>MMP BOQ report will be generated automatically.</li>
                  </ul>
              ...
              <div className="grid grid-cols-2 gap-3 mb-5">
                ...
                <div>
                  <label className="flex items-center gap-1 text-xs font-medium text-[#11499E] mb-1.5">
                    Operator
                    <span className="text-gray-400 text-[10px] cursor-help" title="Operator to generate implementation KMZ algorithm">ⓘ</span>
                  </label>
                  <select
                    value={operator}
                    onChange={(e) => {
                ...
                <div>
                  <label className="flex items-center gap-1 text-xs font-medium text-[#11499E] mb-1.5">
                    Device in Site
                    <span className="text-gray-400 text-[10px] cursor-help" title="Device to place in site">ⓘ</span>
                  </label>
                  <input
                    type="text"
                    value={deviceInSite}
