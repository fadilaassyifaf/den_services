    ...
    <div className="fixed inset-0 bg-slate-900/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-2xl w-full max-w-lg shadow-2xl flex flex-col overflow-hidden" style={{ maxHeight: '80vh' }}>
        ...
        <div className="flex-1 overflow-y-auto px-6 py-5 space-y-5">
          ...
          <div>
            <p className="text-xs font-bold text-[#11499E] mb-2 uppercase tracking-wide">Sample</p>
            <button
              type="button"
              ...
              <form onSubmit={handleExecute}>
                  ...
                  >
                    ...
                    {designFile ? (
                      ...
                      <>
                        ...
                        <p className="text-[10px] text-gray-400 mt-0.5">(.kmz, .kml — DEN intersite format)</p>
                      </>
                    )}
                ...
                <div className="flex flex-col gap-2 mb-3">
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    <Field label="Program" hint="Program name if 'program' column not provided">
                      <input
                    ...
                    <Field label="Operator" hint="Operator to generate implementation KMZ algorithm">
                      <select
                        value={operator}
                        onChange={(e) => {
                    ...
                    <Field label="Device in Branch" hint="Device to place in branch">
                      <select
                    ...
                    <Field label="Device in Site" hint="Device to place in site">
                      <select
                    ...
                    <Field label="IPL Route" hint="Route preference to identify as existing fiber">
                      <select
